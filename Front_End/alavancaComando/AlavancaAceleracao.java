...
public class AlavancaAceleracao extends JPanel {
    ...
    public AlavancaAceleracao(JFrame frame, int ordemCliques) {
        ordemCliques = this.ordemCliques;
        ordemCliques++;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (imagemDeFundo == null) {
            ImageIcon icon = new ImageIcon(getClass().getResource("/alavancaComando/imagens/alavancaAceleracao.jpg"));
    ...
    private void adicionarBotoes() {
        botaoFrenagem = criarBotao(e -> trocarTela(new AlavancaFrenagem(parentFrame, ordemCliques)));
    ...
    private void reposicionarBotoes() {
        ...
        botaoFrenagem.setBounds((int) (w * 0.4), (int) (h * 0.8), (int) (w * 0.2), (int) (h * 0.1));
