...
public class MANUT extends JPanel {
    ...
    public MANUT(JFrame frame) {
        ...
        JButton botao1 = criarBotao(30, 980, 130, 90, e -> trocarTela(new DDUPrincipal(parentFrame)));
        JButton botao2 = criarBotao(615, 980, 130, 90, e -> trocarTela(new FE(parentFrame)));
        JButton botao3 = criarBotao(770, 980, 130, 90, e -> trocarTela(new INFOPASS(parentFrame)));
        JButton botao5 = criarBotao(1350, 980, 130, 90, e -> trocarTela(new MANUT(parentFrame)));
